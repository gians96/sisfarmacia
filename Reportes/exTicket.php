...
<table border="0" align="center" width="300px">
   ...
   <tr>
      <td colspan="1" align="center">__________________________________________</td>
    </tr>
    <tr>
...
<table border="0" align="center" width="300px">
    ...
    $query_ped = $objPedido->ImprimirDetallePedido($_GET["id"]);
        ...
        $pc=0.00;
        $pc=$reg->precio_venta*$reg->cantidad;
        $des=$reg->descuento+$des;
        echo "<tr>";
        echo "<td>".$reg->cantidad."</td>";
        echo "<td>".$reg->articulo. " Lt.".$reg->serie."</td>";
        echo "<td align='right'>". $reg_igv->simbolo_moneda." ".$pc."</td>";
        echo "</tr>";
    ...
    <td align="right"><b><?php echo "-".$reg_igv->simbolo_moneda;?>  <?php echo $des;  ?></b></td>
    </tr>
    <tr>
    <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="3" align="center">SERGIN GG</td>
    </tr>
    <tr>
      <td colspan="3" align="center">San Vicente de Cañete - Lima</td>
    </tr>
