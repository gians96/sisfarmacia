          ...
          case "listVentasDetalladas":
               ...
               while ($reg = $query_Tipo->fetch_object()) {
                    ...
                    $data[] = array(
                         ...
                         "6"=>$reg->numero,
                         "7"=>$reg->impuesto,
                         "8"=>$reg->articulo." ".$reg->descripcion,
                         "9"=>$reg->codigo,
                         "10"=>$reg->serie_art,
                         "11"=>$reg->cantidad,
                         "12"=>$reg->precio_venta,
               ...
               break;
          case "listVentasDetalladasCaja":

               $fecha_desde = $_REQUEST["fecha_desde"];
               $fecha_hasta = $_REQUEST["fecha_hasta"];
               $idsucursal = $_REQUEST["idsucursal"];
               $data;
               $query_Tipo = $objCategoria->ListarVentasDetalladasCaja($idsucursal, $fecha_desde, $fecha_hasta);
          ...
          case "listVentasEmpleadoDet":
               ...
               while ($reg = $query_Tipo->fetch_object()) {
                    ...
                    $data[] = array(
                         ...
                         "7"=>$reg->numero,
                         "8"=>$reg->impuesto,
                         "9"=>$reg->articulo." ".$reg->descripcion,
                         "10"=>$reg->codigo,
                         "11"=>$reg->serie_art,
                         "12"=>$reg->cantidad,
                         "13"=>$reg->precio_venta,
