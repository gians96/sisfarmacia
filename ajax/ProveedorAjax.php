<?php
	...
	switch ($_GET["op"]) {
		...
		case "list":
         ...
         //                <td>'.$reg->email.'</td>
         //                <td>'.$reg->telefono.'</td>
         //                <td>'.$reg->direccion_departamento.'</td>
         //                <td>'.'<button class="btn btn-warning" data-toggle="tooltip" title="Editar" onclick="cargarDataProveedor('.$reg->idpersona.',\''.$reg->tipo_persona.'\',\''.$reg->nombre.'\',\''.$reg->tipo_documento.'\',\''.$reg->num_documento.'\',\''.$reg->direccion_departamento.'\',\''.$reg->direccion_provincia.'\',\''.$reg->direccion_distrito.'\',\''.$reg->direccion_calle.'\',\''.$reg->telefono.'\',\''.$reg->email.'\',\''.$reg->numero_cuenta.'\',\''.$reg->estado.'\')"><i class="fa fa-pencil"></i> </button>&nbsp;'.
     				// '<button class="btn btn-danger" data-toggle="tooltip" title="Eliminar" onclick="eliminarProveedor('.$reg->idpersona.')"><i class="fa fa-trash"></i> </button>'.'</td>
         //               </tr>';
         //         $i++; 
         //    }
