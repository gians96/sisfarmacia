<?php
	...
	class Persona{
		...
		public function ListarProveedor(){
			global $conexion;
			// $sql = "SELECT * FROM persona where tipo_persona='Proveedor' order by idpersona asc limit 0,250";
			$sql = "SELECT * FROM persona where tipo_persona='Proveedor' or tipo_persona='Laboratorio' order by idpersona asc ";
			$query = $conexion->query($sql);
			return $query;
		}
		...
		public function ListarLaboratorio(){
			global $conexion;
			$sql = "SELECT * FROM persona where tipo_persona='Laboratorio' order by idpersona desc";
			$query = $conexion->query($sql);
			return $query;
		}
		...
		public function ReporteLaboratorio(){
			global $conexion;
			$sql = "SELECT * FROM persona where tipo_persona='Laboratorio' order by nombre asc";
			$query = $conexion->query($sql);
			return $query;
		}
